...
const cacheName = 'LA5Adams-2021-09-22 15:22:44.203769'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA5Adams'.length) === 'LA5Adams') {
